  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/membership-form" element={
        <ProtectedRoute><MembershipForm /></ProtectedRoute>
      } />
      <Route path="/loan-application-form" element={
        <ProtectedRoute><LoanApplicationForm /></ProtectedRoute>
      } />
      ...
      <Route path="/terms" element={
        <ProtectedRoute><Terms /></ProtectedRoute>
      } />
    </Routes>
  </Router>
   );
